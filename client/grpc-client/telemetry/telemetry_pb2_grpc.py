...
class CollectorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendTelemetry = channel.unary_unary(
                '/observability.Collector/SendTelemetry',
...
def add_CollectorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'observability.Collector', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('observability.Collector', rpc_method_handlers)
